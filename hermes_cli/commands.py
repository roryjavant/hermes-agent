...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("mac2", "Run one prompt on the other MacBook via othermac-worker", "Session",
               args_hint="<prompt>"),
    ...
    CommandDef("cp", "Send 'commit and push' to the agent", "Session",
               cli_only=True),
    ...
    CommandDef("moa", "Run one prompt through the default Mixture of Agents preset, then restore your model", "Session",
               args_hint="<prompt>"),
    CommandDef("use-5.5", "Run one prompt with GPT 5.5, then restore the session model", "Session",
               args_hint="<prompt>"),
    CommandDef("use-sol", "Run one prompt with GPT 5.6 Sol, then restore the session model", "Session",
               args_hint="<prompt>"),
    CommandDef("use-terra", "Run one prompt with GPT 5.6 Terra, then restore the session model", "Session",
               args_hint="<prompt>"),
    ...
    CommandDef("5.5", "Switch this terminal/TUI session to GPT 5.5", "Configuration",
               cli_only=True, args_hint="[--global|--session]"),
    CommandDef("sol", "Switch this terminal/TUI session to GPT 5.6 Sol", "Configuration",
               cli_only=True, args_hint="[--global|--session]"),
    CommandDef("terra", "Switch this terminal/TUI session to GPT 5.6 Terra", "Configuration",
               cli_only=True, args_hint="[--global|--session]"),
