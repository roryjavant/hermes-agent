...
/**
 * App-wide cockpit banner shown while the global switcher targets a profile
...
export function ProfileScopeBanner() {
  ...
  return (
    ...
    <div className="mt-14 lg:mt-0 flex items-center gap-2 border-b border-primary/35 bg-primary/10 px-4 py-1.5 font-mono-ui text-xs uppercase tracking-[0.08em] text-primary">
